...
using Victa.Backend.Accounts.Infrastructure.Identity.Adapters;
using Victa.Backend.Accounts.Infrastructure.IdentityServer.Adapters.Services;
using Victa.Backend.Accounts.Infrastructure.IdentityServer.Adapters.Stores.Configurational;
using Victa.Backend.Accounts.Infrastructure.IdentityServer.Adapters.Stores.Operational;
using Victa.Backend.Accounts.Infrastructure.IdentityServer.Adapters.Validation;
using Victa.Backend.Infrastructure.IdentityServer.Validation;

namespace Victa.Backend.Accounts.Infrastructure.IdentityServer;
